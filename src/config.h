...
// Credentials are supplied via build flags from secrets.ini (see platformio.ini).
// The placeholder values below are intentionally invalid — the device will not
// join a real network without correct values in secrets.ini.
